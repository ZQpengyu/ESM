...
def test(config: Config, mind_corpus: MIND_Corpus):
    ...
    auc, mrr, ndcg5, ndcg10 = compute_scores(model, mind_corpus, config.batch_size * 3//2 // config.world_size, 'test', test_res_dir + '/' + model.model_name + '.txt', config.dataset)
...
if __name__ == '__main__':
    ...
    #[self.user_ID_dict[user_ID], user_history, user_history_mask, click_impression, non_click_impressions, behavior_index])
