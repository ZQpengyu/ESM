...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--score1', type=str, default='1')
        parser.add_argument('--score2', type=str, default='1')
        #parser.add_argument('--num_keywords', type=str, default='8')
        parser.add_argument('--score3', type=str, default='1.9')
        parser.add_argument('--lossw', type=str, default='1.6')
        ...
        # Dataset config
        parser.add_argument('--dataset', type=str, default='500k', choices=['200k', 'small', 'large'], help='Dataset type')
